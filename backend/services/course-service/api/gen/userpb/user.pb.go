...
type UserRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Use int64 to match the Go int64 type
}
...
type UserResponse struct {
	...
	Id       int64  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`            // Change to int64 to match the Go User struct
	Username string `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty"` // Updated field name to match User struct
...
type CreateUserRequest struct {
	...
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // Updated field name to match User struct
...
type GetUsersResponse struct {
	...
	Users []*User `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"` // Array of User messages
}
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x26, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x34, 0x0a, 0x10, 0x47, 0x65,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72,
	0x6e, 0x61, 0x6d, 0x65, 0x32, 0xbc, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x70, 0x62, 0x62,
...
var file_proto_user_proto_depIdxs = []int32{
	...
	6, // 3: user.UserService.GetUsers:input_type -> google.protobuf.Empty
